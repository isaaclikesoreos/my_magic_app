...
1. Make sure you have Python 3.12 and mysql installed on your computer
...
8. Run `python manage.py migrate` to set up the database
9. Run `python django-starter-main/manage.py runserver` to build the application
